...
class Accrual
{
    ...
    #[ORM\ManyToOne(inversedBy: 'accruals')]
     ...
     */
    #[ORM\OneToMany(targetEntity: Adjustment::class, mappedBy: 'accrual')]
    ...
    public function removeAdjustment(Adjustment $adjustment): static
    {
        if ($this->adjustments->removeElement($adjustment)) {
            ...
            if ($adjustment->getAccrual() === $this) {
                $adjustment->setAccrual(null);
            }
        }
